...
*/
/*
    module과 plugins의 차이점
    -module : 기본적으로 webpack(자바스크립트를 하나로 합쳐주는 역할)의 대부분의 역할을 함
        -> 자바스크립트가 아닌 애들(ex. vue, css 파일 등등)을 자바스크립트로 만들어주는 역할 (= loader의 역할)
    -plugins : 부가적인 역할 (module이 중심임)
        -> ex. output으로 나오기 전에 압축, 추가 등등 
*/